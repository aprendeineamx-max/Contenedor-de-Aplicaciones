...
Agregar la dependencia directamente desde Git mientras el crate no esté publicado:

```
[dependencies]
orbit_cli_sdk = { git = "https://github.com/aprendeineamx-max/Contenedor-de-Aplicaciones.git", package = "orbit_cli_sdk", rev = "1884d14" }
```

> Sustituye `rev` por el commit/tag deseado para builds reproducibles.
